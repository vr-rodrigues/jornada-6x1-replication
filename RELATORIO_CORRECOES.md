# Relatório de correções e replicação

Execução: `20260905_205717_009603`. Código, dados reais, resultados nacionais e setoriais, tabelas e figuras foram executados. O comando original falhou por dependência de output setorial antigo; o executor corrigido gera esse resultado antes das figuras. Nenhum parâmetro foi escolhido para recuperar os números antigos.
...
| Eficiência | Teto | ΔY % | A_req % | A_fixo % | Informalidade % | ΔGHH % | CE % |
|---|---:|---:|---:|---:|---:|---:|---:|
| Bilateral | 40 | -2,0129 | 1,9232 | 1,8681 | 41,4512 | 0,2338 | 0,1832 |
| Bilateral | 36 | -8,0708 | 8,1768 | 7,9453 | 43,1413 | -4,0611 | -3,1812 |
| Fadiga acima do pico | 40 | -2,0084 | 1,9187 | 1,8637 | 41,4502 | 0,2395 | 0,1876 |
| Fadiga acima do pico | 36 | -6,6306 | 6,6220 | 6,4338 | 42,7292 | -2,1687 | -1,6988 |

### PNAD reprocessada, baseline habitual observado e ponte horária recalibrada

| Eficiência | Teto | ΔY % | A_req % | A_fixo % | Informalidade % | ΔGHH % | CE % |
|---|---:|---:|---:|---:|---:|---:|---:|
| Bilateral | 40 | -0,0800 | 0,0739 | 0,0703 | 38,6261 | 3,9555 | 3,0985 |
| Bilateral | 36 | -6,9067 | 6,7968 | 6,4529 | 40,9728 | -1,0075 | -0,7892 |
| Fadiga acima do pico | 40 | -0,0780 | 0,0721 | 0,0685 | 38,6254 | 3,9581 | 3,1005 |
| Fadiga acima do pico | 36 | -5,1653 | 5,0013 | 4,7493 | 40,3494 | 1,2237 | 0,9586 |

### Hipótese alternativa: baseline formal previamente limitado a 44h

| Eficiência | Teto | ΔY % | A_req % | A_fixo % | Informalidade % | ΔGHH % | CE % |
|---|---:|---:|---:|---:|---:|---:|---:|
| Bilateral | 40 | -1,6766 | 1,5726 | 1,4941 | 39,1520 | 0,2250 | 0,1762 |
| Bilateral | 36 | -8,3976 | 8,3813 | 7,9555 | 41,5208 | -4,3659 | -3,4199 |
| Fadiga acima do pico | 40 | -1,6358 | 1,5338 | 1,4572 | 39,1384 | 0,2763 | 0,2164 |
| Fadiga acima do pico | 36 | -6,6462 | 6,5244 | 6,1945 | 40,8786 | -2,1210 | -1,6614 |
...
| Eficiência | Teto | Horas físicas | Eficiência | Realocação | Total |
|---|---:|---:|---:|---:|---:|
| bilateral | 40 | -3,0849 | 3,0147 | -0,0097 | -0,0800 |
| bilateral | 36 | -7,4859 | 1,4242 | -0,8450 | -6,9067 |
| flat_below | 40 | -3,0071 | 2,9386 | -0,0095 | -0,0780 |
| flat_below | 36 | -7,2931 | 2,7591 | -0,6313 | -5,1653 |
...
Testes desta execução: código de retorno `0`; log em `logs/tests.log`. A suíte verifica transformação das participações, FOCs e fronteiras, CES, restauração com ambas as composições, soma da decomposição, CE/GHH, recursos, categorias PNAD, trimestre, ausentes, pesos, rendimentos e RAIS. Os testes antigos que exigiam recuperar números anteriores foram substituídos por propriedades matemáticas. Máximos de erro na execução: `{'max_foc_violation': 1.90983340253581e-14, 'max_output_restoration_error': 1.9984014443252818e-15, 'max_decomposition_error_pct': 1.7763568394002505e-15, 'max_ce_identity_error': 1.0602629885170245e-14}`. A revisão independente da ponte está em [AUDITORIA_NUCLEO.md](docs/AUDITORIA_NUCLEO.md).
...
- `.gitattributes`
- `.gitignore`
- `docs/audit_saved_outputs.py`
- `docs/AUDITORIA_DADOS.md`
- `docs/AUDITORIA_NUCLEO.md`
- `docs/AUDITORIA_SAIDAS_EXECUTADAS.json`
- `docs/AUDITORIA_SETORIAL.md`
- `docs/generate_manuscript_inventory.py`
- `docs/MANIFESTO_INVENTARIO_MANUSCRITO.json`
- `docs/NUMEROS_MANUSCRITO_A_REVISAR.md`
- `README.md`
- `RELATORIO_CORRECOES.md`
- `reproduce.py`
- `requirements-replication.lock.txt`
- `requirements.txt`
- `run_all.py`
- `src/calibration/asymmetric_eh.py`
- `src/calibration/audit_fit_moments.py`
- `src/calibration/calibrate_all.py`
- `src/calibration/calibrate_flatbelow.py`
- `src/calibration/corrected_pipeline.py`
- `src/calibration/efficiency_diagnostics.py`
- `src/calibration/fatigue_scan.py`
- `src/calibration/joint_envelope.py`
- `src/calibration/joint_envelope_flat.py`
- `src/calibration/probe_original.py`
- `src/calibration/solve_sigma_for_R.py`
- `src/calibration/wage_bridge.py`
- `src/calibration/write_corrections_report.py`
- `src/data_clean/clean_and_merge.py`
- `src/data_raw/collect_rais.py`
- `src/data_raw/reprocess_verified_inputs.py`
- `src/model/areq_solver.py`
- `src/model/calibration.py`
- `src/model/ces_aggregator.py`
- `src/model/decomposition.py`
- `src/model/efficiency.py`
- `src/model/firm_problem.py`
- `src/model/groups.py`
- `src/model/production.py`
- `src/model/simulation.py`
- `src/model/welfare.py`
- `src/sectoral/data/collect_sectoral_data.py`
- `src/sectoral/data/pnad_sectoral_microdata.R`
- `src/sectoral/model/decomposition.py`
- `src/sectoral/model/inputs.py`
- `src/sectoral/model/red_team_tests.py`
- `src/sectoral/model/run_empirical.py`
- `src/sectoral/model/sector_assets.py`
- `src/sectoral/model/sector_model.py`
- `src/sectoral/model/sensitivity.py`
- `src/sectoral/model/workers_affected.py`
- `src/tables_figures/build_corrected_assets.py`
- `src/tables_figures/current_run.py`
- `src/tables_figures/plot_calibration_fit.py`
- `src/tables_figures/plot_figures_pt.py`
- `src/tables_figures/plot_main_figures.py`
- `src/tables_figures/plot_welfare_schedule.py`
- `src/tables_figures/write_appendix_tables.py`
- `src/tables_figures/write_corrected_appendix.py`
- `src/tables_figures/write_pt_autogen_tables.py`
- `tests/test_model.py`
- `tests/test_pipeline_corrected.py`
- `tests/test_sectoral_corrected.py`
- `tests/test_verified_empirical.py`
- `tests/test_wage_bridge.py`
